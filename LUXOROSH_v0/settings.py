"""
Django settings for LUXOROSH_v0 project.
...
SECRET_KEY = 'j1mz)s5ob1#(6$gp=ap56q=f9xvp5h%f+47cywc_i(6fj31a=n'
...
WSGI_APPLICATION = 'LUXOROSH_v0.wsgi.application'
